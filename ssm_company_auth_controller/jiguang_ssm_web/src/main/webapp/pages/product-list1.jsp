                        ...
                        <ul class="pagination">
                            ...
                            <li>
                                <c:forEach begin="1" end="${productList.pages}" var="pageNum">
                                    <a href="${pageContext.request.contextPath}/product/findAll.do?page=${pageNum}&size=${productList.pageSize}">${pageNum}</a>
                                </c:forEach>
                            </li>
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/product/findAll.do?page=${productList.pages}&size=${productList.pageSize}" aria-label="Previous">尾页</a>
                            </li>
                        </ul>
                    </div>
