...
//        comboPooledDataSource.setDriverClass("com.mysql.cj.jdbc.Driver");
        ApplicationContext context1=new ClassPathXmlApplicationContext("beans12.xml");
        //2.

        IAccountService iAccountService= (IAccountService) context1.getBean("accountService");
        iAccountService.transfer("rose", "jack", 666);
